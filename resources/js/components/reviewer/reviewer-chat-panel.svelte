<script lang="ts">
    import CommentSection from '@/components/reviewer/comment-section.svelte';
    import CommentForm from '@/components/reviewer/comment-form.svelte';
...
<div class="flex flex-col h-full bg-background">
    <!-- Status Header -->
    <div class="flex items-center justify-between px-6 py-3 border-b bg-muted/20">
        <span class="text-sm font-medium text-muted-foreground">Komentar</span>
    </div>
