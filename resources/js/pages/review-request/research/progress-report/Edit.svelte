<script lang="ts">
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Laporan Kemajuan', href: '/apply/research/progress-report' },
        { title: 'Revisi', href: '#' },
    ];
    ...
    function submit() {
        ...
        $form.post(route('apply.research.progress_report.revise', submission.id), {
            onSuccess: () => {
...
<AppLayout {breadcrumbs}>
    <LayoutComposer>
        ...
        {#snippet children()}
            ...
            >
                <ProgressReportForm bind:form={$form} data={{ schemas }} type="research" mode="revise" />
