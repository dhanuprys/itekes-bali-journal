        ...
        <div class="space-y-4">
            {#if hasOngoing}
                <Alert.Root class="bg-blue-50 border-blue-200 text-blue-800 dark:bg-blue-950 dark:border-blue-900 dark:text-blue-200">
                    ...
                    <Alert.Description>
                        Anda masih memiliki usulan penelitian yang sedang berjalan. Anda baru dapat mengajukan usulan baru setelah usulan saat ini
                        selesai (Laporan Akhir disetujui) atau dibatalkan/ditolak.
                    </Alert.Description>
                </Alert.Root>
            {/if}
