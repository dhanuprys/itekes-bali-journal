...
<AppLayout {breadcrumbs}>
    <LayoutComposer>
        {#snippet header()}
            <Heading title="Laporan Akhir" description="Daftar laporan akhir pengabdian yang telah disetujui." />
        {/snippet}

        <Card.Root>
            <Card.Header>
                <Card.Title>Daftar Laporan</Card.Title>
                <Card.Description>Semua pengabdian yang telah selesai dan disetujui laporannya.</Card.Description>
            </Card.Header>
            <Card.Content>
                            ...
                            {#each submissions.data as submission (submission.id)}
                                <Table.Row>
                                    ...
                                    <Table.Cell class="text-right">
                                        <Button variant="ghost" size="sm" href={route('apply.community_service.final_report.show', submission.id)}>
                                            Detail
                                        </Button>
                                    </Table.Cell>
                                </Table.Row>
