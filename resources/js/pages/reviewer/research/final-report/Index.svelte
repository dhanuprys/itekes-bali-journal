...
<AppLayout {breadcrumbs}>
    <LayoutComposer>
        {#snippet header()}
            <Heading title="Review Laporan Akhir" description="Daftar laporan akhir penelitian yang perlu direview." />
        {/snippet}
                                ...
                                {#each submissions.data as submission}
                                    <Table.Row>
                                        ...
                                        <Table.Cell class="text-right">
                                            <Button size="sm" href={route('review.research.final_report.show', submission.id)}>Review</Button>
                                        </Table.Cell>
                                    </Table.Row>
                                {/each}
                            </Table.Body>
