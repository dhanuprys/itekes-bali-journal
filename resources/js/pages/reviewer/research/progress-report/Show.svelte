            ...
            <ReviewerSplitLayout>
                ...
                {#snippet actions()}
                    <ReviewerChatPanel
                        {comments}
                        {canReview}
                        commentSubmitRoute={route('review.research.progress_report.comment', submission.id)}
                        actionSubmitRoute={route('review.research.progress_report.change-state', submission.id)}
                    />
                {/snippet}
            </ReviewerSplitLayout>
        {/snippet}
