...
<svelte:head>
    <title>Daftar Review Proposal Pengabdian</title>
</svelte:head>

<AppLayout {breadcrumbs}>
    <LayoutComposer>
        {#snippet header()}
            <Heading title="Review Proposal" description="Daftar proposal pengabdian yang perlu direview." />
        {/snippet}
                                ...
                                {#each submissions.data as submission}
                                    <Table.Row>
                                        ...
                                        <Table.Cell class="text-right">
                                            <Button size="sm" href={route('review.community_service.proposal.show', submission.id)}>Review</Button>
                                        </Table.Cell>
                                    </Table.Row>
                                {/each}
                            </Table.Body>
