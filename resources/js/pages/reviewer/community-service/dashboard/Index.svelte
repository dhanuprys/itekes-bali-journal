<script lang="ts">
    ...
    function getReviewRoute(submission: any) {
        if (submission.stage === 'proposal') return route('review.community_service.proposal.show', submission.id);
        if (submission.stage === 'progress_report') return route('review.community_service.progress_report.show', submission.id);
        if (submission.stage === 'final_report') return route('review.community_service.final_report.show', submission.id);
        return '#';
    }
...
<svelte:head>
    <title>Reviewer Dashboard - Pengabdian</title>
</svelte:head>
