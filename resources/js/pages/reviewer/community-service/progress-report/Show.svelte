    ...
    <LayoutComposer>
        ...
        {#snippet children()}
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Right Column -->
                <div class="space-y-6">
                    <CommentSection {comments} submitRoute={route('review.community_service.progress_report.comment', submission.id)} />

                    <ReviewActions {canReview} submitRoute={route('review.community_service.progress_report.change-state', submission.id)} />
                </div>
            </div>
        {/snippet}
    </LayoutComposer>
